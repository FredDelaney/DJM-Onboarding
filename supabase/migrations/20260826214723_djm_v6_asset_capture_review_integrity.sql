create or replace function public.djm_network_capture_asset(p_storage_path text, p_capture_type text, p_channel text default 'whatsapp', p_person_id uuid default null, p_organisation_id uuid default null)
